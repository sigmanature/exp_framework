#!/bin/bash
# launch_kfragd_100ms_kcompressd.sh — kfragd force-reclaim + 100ms interval + 16KB THP + kcompressd 异步压缩 实验启动器
# 用法: bash scripts/launch_kfragd_100ms_kcompressd.sh
...
REQS=(
  ...
  "kcompressd_enabled|/sys/module/kcompressd/parameters/kcompressd_enabled|1"
)
